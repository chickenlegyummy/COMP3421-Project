 ...
 * Handles filtering, sorting, pagination, and product display - API Version
 */
...
class ProductsPage {
    ...
    async loadProducts() {
        try {
            ...
            // Fetch from API
            const response = await apiRequest(`${API.PRODUCTS.LIST}?${params.toString()}`);
...
// Global function to add product to cart from product cards
